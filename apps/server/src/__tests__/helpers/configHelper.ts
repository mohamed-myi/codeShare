...
export function createTestConfig(overrides?: Partial<Config>): Config {
  return {
    ...
    JUDGE0_CB_FAILURE_THRESHOLD: 5,
    JUDGE0_CB_RESET_TIMEOUT_MS: 30_000,
    GROQ_CB_FAILURE_THRESHOLD: 5,
    GROQ_CB_RESET_TIMEOUT_MS: 30_000,
